...
**Patient**: Priscilla K.
**Date**: February 2026
**Requesting**: Follow-up blood panel based on AI-assisted genetic analysis and previous results
...
## My Previous Blood Results (Reference)
...
| Gene | rsID | My Genotype | Clinical Impact |
|------|------|-------------|----------------|
...
| GC (Vitamin D transport) | rs4588 | T/T | Poor Vitamin D transport — needs higher supplementation |
...
| Test | Why |
|------|-----|
| **hs-CRP** (high-sensitivity C-Reactive Protein) | Was 9 mg/L last time. Need to track if supplement protocol (NAC, Omega-3, Curcumin) is lowering systemic inflammation. |
| **Homocysteine** | MTHFR A/G variant → reduced methylation. Target: < 9 µmol/L. Elevated homocysteine scratches artery walls → compounds 9p21 CVD risk. |
| **Ferritin + Iron Studies** (full panel: Ferritin, Serum Iron, TIBC, Transferrin Saturation) | HFE H63D carrier. Was 205 µg/L. Need to monitor iron overload progression — directly fuels vascular calcification with my 9p21. |
| **Full Lipid Panel** (Total Cholesterol, LDL, HDL, Triglycerides) | Baseline for 9p21 G/G cardiovascular monitoring. |
| **ApoB** (Apolipoprotein B) | The single best predictor of cardiovascular events. With 9p21 G/G, my target should be < 60 mg/dL (5th percentile). LDL alone is insufficient — ApoB counts the actual atherogenic particles. |
| **HbA1c** (Glycated Haemoglobin) | TCF7L2 T/C = fragile pancreas. HbA1c shows 3-month average blood sugar. Early T2D detection. |
| **25(OH)D** (Vitamin D) | GC rs4588 T/T = poor Vitamin D transport. Currently on high-dose D3 loading protocol. Need to check levels — target: 50–80 ng/mL (125–200 nmol/L). |
| **FBC** (Full Blood Count) | Platelets were 509, WBC was 12.6. Need to track if these are normalising. |

### 🟡 Priority 2 — Strongly Recommended

| Test | Why |
|------|-----|
| **TSH + Free T4 + Free T3** (full thyroid panel) | TSH was borderline low (0.37). Currently avoiding selenium due to this. Full panel needed to rule out subclinical hyperthyroidism. |
| **Fasting Insulin** | Complements HbA1c for TCF7L2 risk. Shows insulin resistance before blood sugar rises. |
| **Fasting Glucose** | Paired with insulin to calculate HOMA-IR (insulin resistance index). |
| **Omega-3 Index** (if available) | Currently supplementing 2700mg EPA+DHA daily. Target: > 8%, ideally 12%. Validates whether supplementation is reaching tissue levels. |
| **Liver Function Tests** (ALT, AST, GGT, ALP) | PNPLA3 C/G = fatty liver risk. Curcumin protocol is hepatoprotective — good to have baseline. |

### 🟢 Priority 3 — If Possible

| Test | Why |
|------|-----|
| **Uric Acid** | Inflammatory marker that correlates with metabolic syndrome. Useful given TCF7L2 + KLF14 profile. |
| **ESR** (Erythrocyte Sedimentation Rate) | Secondary inflammation marker to cross-reference with CRP. |
| **Vitamin B12 + Folate** | Verify that activated B-complex supplementation is adequately bypassing MTHFR A/G bottleneck. |
| **Calcium** | High-dose Vitamin D3 + K2 supplementation — need to ensure calcium is being directed to bones, not accumulating in blood. |
| **Magnesium (RBC)** | Supplementing 400mg Mg glycinate nightly. RBC magnesium is more accurate than serum magnesium. |

---

## Current Supplement Protocol (For Your Records)
...
| Vitamin D3 | 30,000 IU (loading — 8 weeks) | GC T/T poor transport |
| Activated B-Complex + L-Theanine | 1 cap | MTHFR A/G, COMT G/G |
| Turmeric/Curcumin | 2 caps (28,000+ complex) | CRP, TNF-Alpha |
| Blood Sugar Babe (myo-inositol blend) | 4g | TCF7L2 diabetes risk |
| Phloe (Zyactinase) | 2 caps | Gut integrity, CRP |
| Magnesium Glycinate | 400mg elemental | SIRT1 circadian, BDNF sleep |

> **Note for prescribing**: My CYP3A4 T/C means I am a rapid metaboliser of many drugs including statins. Standard doses may be insufficient. CYP1A2 A/C means caffeine clears very slowly (10+ hour half-life).
...
3. **Discuss the HLA-B27 finding** — I'd like to know if a formal rheumatology referral is warranted given the Ankylosing Spondylitis risk
4. **Discuss the HLA-DRB1 finding** — any screening or monitoring recommendations for MS risk
5. **Iron management plan** — is regular blood donation sufficient for my HFE H63D / Ferritin 205, or should we consider therapeutic phlebotomy?
