...
def generate_tier_file(tier: int, header_lines: list[str], rows: list[str]) -> str:
    ...
    lines.append(f"---\n")
    lines.append(f"\n")
    lines.append(f"> **Navigation**: [CANONICAL.md](CANONICAL.md) · ")
    lines.append(f"[Tier 1](CANONICAL_TIER1.md) · ")
    lines.append(f"[Tier 2](CANONICAL_TIER2.md) · ")
    lines.append(f"[Tier 3](CANONICAL_TIER3.md)\n")
...
def rewrite_canonical_section4(before: list[str], header: list[str], 
    ...
    result.append("> are in [CANONICAL_TIER2.md](CANONICAL_TIER2.md)\n")
    result.append("> (156 entries, ~54KB — loaded when domain matches). Historical/niche frameworks are in\n")
    result.append("> [CANONICAL_TIER3.md](CANONICAL_TIER3.md)\n")
