...
- [ ] Read all checkpoints from current session log
- [ ] Identify key decisions and insights
...
## Phase 2.5: Intuition Capture

// turbo

- [ ] Update `.context/heuristics.md` — add any new gut rules learned this session
