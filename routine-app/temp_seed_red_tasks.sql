...
-- Ensure requested Red tasks are present and set to Unscheduled by default
INSERT INTO public.symphony_tasks_master (title, description, time_target, priority_color, points, tags) VALUES
('Pick up dog (Quinn) poop from the lawn', 'Clear the lawn', 'Unscheduled', 'RED', 1, ARRAY['Pet Care', 'Chores']),
('Walk Quinn (Zone 2 Cardio)', '1-Hr brisk walk + 10 mins training', 'Unscheduled', 'RED', 5, ARRAY['Pet Care', 'Health']),
('15m train Quinn', 'Mental stimulation and obedience', 'Unscheduled', 'RED', 2, ARRAY['Pet Care']),
('Shower & Prep', 'Have a quick shower, tidy up', 'Unscheduled', 'RED', 1, ARRAY['Prep', 'Self Care'])
